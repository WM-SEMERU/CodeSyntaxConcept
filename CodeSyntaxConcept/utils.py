...
# %% auto 0
__all__ = ['traverse', 'find_nodes', 'unroll_node_types', 'convert_to_offset', 'get_test_sets', 'get_sub_set_test_set']
...
def get_test_sets(test_set, language, max_token_number, model_tokenizer, with_ranks=False, num_proc=1):
        subset = test_set.filter(lambda sample: True if sample['language']== language 
            ...
            and len(model_tokenizer.tokenizer(sample['whole_func_string'])) < max_token_number
