...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'CodeSyntaxConcept.aggregator': { 'CodeSyntaxConcept.aggregator.bind_bpe_tokens': ( 'aggregation_function.html#bind_bpe_tokens',
                                              ...
                                              'CodeSyntaxConcept.aggregator.process_bindings': ( 'aggregation_function.html#process_bindings',
                                                                                                 'CodeSyntaxConcept/aggregator.py')},
            'CodeSyntaxConcept.core.data.code_search_net': {},
            'CodeSyntaxConcept.core.parsers.tree_sitter_parser': {},
            'CodeSyntaxConcept.embedding': { 'CodeSyntaxConcept.embedding.get_concept_embeddings': ( 'embedding_function.html#get_concept_embeddings',
                                                                                                     'CodeSyntaxConcept/embedding.py')},
